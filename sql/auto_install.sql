...
-- /*******************************************************
-- *
-- * civicrm_report_organizer_template
-- *
-- * Table that contains the sections for report templates
-- *
-- *******************************************************/
CREATE TABLE `civicrm_report_organizer_template` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique ReportOrganizer ID',
  `component_id` int unsigned COMMENT 'FK to CiviCRM Component',
  ...
  CONSTRAINT FK_civicrm_report_organizer_template_component_id FOREIGN KEY (`component_id`) REFERENCES `civicrm_component`(`id`) ON DELETE CASCADE
)
;
