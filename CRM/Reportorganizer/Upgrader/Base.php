 ...
 */
class CRM_Reportorganizer_Upgrader_Base {

  /**
   * @var CRM_Reportorganizer_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Reportorganizer_Upgrader(
        'reportorganizer',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Reportorganizer_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Reportorganizer_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
